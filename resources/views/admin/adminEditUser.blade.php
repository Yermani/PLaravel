                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" value="{{$user->name}}" name="name" class="form-control" id="exampleInputName1" placeholder=" Prénom et nom" required>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="examplenaissance">Date de naissance</label>
                        <input type="date" value="{{$user->naissance}}" name="naissance" class="form-control" id="examplenaissance" placeholder=" Date de naissance">
                      </div>
                    </div>
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" value="{{$user->passport}}" name="passport" class="form-control" id="examplepassport" placeholder="N° Passport">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="examplecnss">N° CNSS</label>
                        <input type="text" value="{{$user->cnss}}" name="cnss" class="form-control" id="examplecnss" placeholder="N° CNSS">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="examplebanque">Banque</label>
                        <input type="text" value="{{$user->banque}}" name="banque" class="form-control" id="examplebanque" placeholder=" Détails de banque">
                      </div>
                    </div>
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" value="{{$user->rib}}" name="rib" class="form-control" id="exampleRIB" placeholder="RIB">
                      </div>
                    </div>
                    ...
                    <div class="row">
                     ...
                     <div class="col-md-12"> 
                      <div class="form-group">
                        ...
                        <input type="email" value="{{$user->email}}" name="email" class="form-control" id="exampleInputEmail1" placeholder="exemple@sarost-group.com" required>
                      </div>
                      </div>

                      <div class="col-md-12">
                      <div class="form-group">
                        <label for="exampleInputPassword1">Mot de passse</label>
                        <input type="text"  name="password" autocomplete="off" minlength="8" class="form-control" id="exampleInputPassword1" placeholder="Laisser vide pour ne pas changer">
                      </div>
                      </div>
              ...
              <div class="card card-success">
                <div class="card-header">
                  ...
                  <div class="card-body">
                    ...
                    Est ce que vous êtes sur de vouloir modifier ce User ?
